...
from .factories import (
    RecipeCategoryFactory, RecipeFactory, RecipeLikeFactory
)
...
class RecipeModelTest(TestCase):
    ...
    def test_get_total_number_of_likes(self):
        recipe = self.recipe
        total_number_of_likes = recipe.likes.count()
        self.assertEqual(recipe.get_total_number_of_likes(),
                         total_number_of_likes)

    def test_total_number_of_bookmarks(self):
        recipe = self.recipe
        total_number_of_bookmarks = recipe.bookmarked_by.count()
        self.assertEqual(recipe.get_total_number_of_bookmarks(),
